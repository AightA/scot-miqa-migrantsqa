...
INSERT INTO users (username,email, password) values ('zan','admin@cyf.org', 'admin_password');
...
insert into questions (content,date_posted,tags,is_answered ,score,user_id ) values('IMy wife and I are arriving in the UK in october and will','2015-02-21','wife',true,4,2);
